...
class Settings:
    ...
    def __init__(self):
        ...
        self.LONG_TERM_MEMORY_MODEL = os.getenv("LONG_TERM_MEMORY_MODEL", "google/gemini-2.0-flash-001")
        self.LONG_TERM_MEMORY_EMBEDDER_MODEL = os.getenv("LONG_TERM_MEMORY_EMBEDDER_MODEL", "google/embedding-001")
        ...
        self.POSTGRES_DB = os.getenv("POSTGRES_DB", "ai_conf_db")
